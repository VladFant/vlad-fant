...
document.addEventListener("DOMContentLoaded", function() {
    const form = document.getElementById("googl-form");
    ...
    form.addEventListener("submit", async function(event) {
        ...
        // Ваша логіка обробки даних тут, якщо необхідно

        // Асинхронний запит на сервер (AJAX) для відправки даних форми
        ...
        if (response.ok) {
            // Скидання форми в початковий вигляд після відправки
            form.reset();
        } else {
            console.error("Помилка під час відправки форми");
        }
    });
});
